...
const iconMap: Record<string, { icon: ReactNode; colorClass: string }> = {
    ...
    "API Refactoring": { icon: <FiZap />, colorClass: "text-blue-400" },
    "Web Vitals Optimisation": { icon: <FiZap />, colorClass: "text-yellow-400" },
    ...
    Vercel: { icon: <SiVercel />, colorClass: "text-white" },
